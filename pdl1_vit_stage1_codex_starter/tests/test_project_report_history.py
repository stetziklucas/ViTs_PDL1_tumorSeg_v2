...
class ProjectReportHistoryTests(unittest.TestCase):
    def test_discovery_and_labels(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertEqual(ie[0]['verification_regions_warning'], 'none')
